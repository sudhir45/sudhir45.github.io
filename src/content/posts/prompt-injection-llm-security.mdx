...
Short answer: yes - every example above hit a real product or made real headlines. And it goes beyond chat tricks: Carnegie Mellon researchers showed that carefully crafted prompts could extract training data (like email addresses and phone numbers) from LLMs, and security firm Mithril Security demonstrated how poisoned documents could make models reveal sensitive data.
...
LLMs are powerful, but they're not magically safe. Treat them like any other untrusted input, and you'll sleep better.
